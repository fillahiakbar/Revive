    ...
    <div class="min-h-screen flex justify-center px-4 py-6">
        <div class="w-[500px] px-6 sm:px-10 py-10 rounded-xl">
            ...
            <div class="flex flex-col items-center justify-center mb-6 text-center">
                ...
                <h1 class="text-2xl font-bold mt-4 text-white">تسجيل مسؤول جديد</h1>
            </div>
            ...
            <form method="POST" action="{{ route('admin.register.submit') }}" class="space-y-5">
                ...
                <div class="mt-4 text-right text-sm text-white">
                    <span>هل لديك حساب مسؤول؟</span>
                    <a class="text-blue-400 hover:underline" href="{{ route('admin.login') }}">تسجيل الدخول</a>
                </div>
            </form>
        </div>
    </div>
